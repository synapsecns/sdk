...
export interface NerveBridgeZapInterface extends ethers.utils.Interface {
  functions: {
...
export interface NerveBridgeZap extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NerveBridgeZapInterface;
