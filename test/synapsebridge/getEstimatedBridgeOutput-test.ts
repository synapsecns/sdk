...
describe("SynapseBridge - getEstimatedBridgeOutput tests", function(this: Mocha.Suite) {
    ...
    [
        ...
        makeTestCase(Tokens.MULTI_AVAX,  Tokens.AVAX,      ChainId.HARMONY,     ChainId.AVALANCHE),
        makeTestCase(Tokens.MULTI_AVAX,  Tokens.WAVAX,     ChainId.HARMONY,     ChainId.DFK),
        makeTestCase(Tokens.AVAX,        Tokens.MULTI_AVAX,ChainId.AVALANCHE,   ChainId.HARMONY),
