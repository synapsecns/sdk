...
describe("SynapseBridge - buildBridgeTokenTransaction tests", function(this: Mocha.Suite) {
    ...
    [
        ...
        makeTestCase(Tokens.MULTI_AVAX, Tokens.AVAX,      ChainId.HARMONY,   ChainId.AVALANCHE,   swapAndRedeem),
        makeTestCase(Tokens.AVAX,       Tokens.MULTI_AVAX,ChainId.AVALANCHE, ChainId.HARMONY,     depositETHAndSwap),
        makeTestCase(Tokens.WAVAX,      Tokens.MULTI_AVAX,ChainId.DFK,       ChainId.HARMONY,     redeemAndSwap),
        makeTestCase(Tokens.WAVAX,      Tokens.MULTI_AVAX,ChainId.MOONBEAM,  ChainId.HARMONY,     redeemAndSwap),
        makeTestCase(Tokens.AVAX,       Tokens.WAVAX,     ChainId.AVALANCHE, ChainId.MOONBEAM,    depositETH),
        makeTestCase(Tokens.SYN_AVAX,   Tokens.AVAX,      ChainId.HARMONY,   ChainId.AVALANCHE,   redeem),
        ...
        makeTestCase(Tokens.VSTA,       Tokens.VSTA,      ChainId.ARBITRUM,  ChainId.ETH,         deposit),
        makeTestCase(Tokens.VSTA,       Tokens.VSTA,      ChainId.ETH,       ChainId.ARBITRUM,    redeem),
        makeTestCase(Tokens.USDB,       Tokens.USDB,      ChainId.FANTOM,    ChainId.ETH,         redeem),
        makeTestCase(Tokens.USDB,       Tokens.USDB,      ChainId.ETH,       ChainId.FANTOM,      redeem),
        makeTestCase(Tokens.DFKTEARS,   Tokens.DFKTEARS,  ChainId.HARMONY,   ChainId.DFK,         deposit),
        ...
        makeTestCase(Tokens.SFI,        Tokens.SFI,       ChainId.ETH,       ChainId.AVALANCHE,   deposit),
        ...
        makeTestCase(Tokens.USDC,       Tokens.USDC,      ChainId.KLAYTN,    ChainId.ETH,         redeem),
        makeTestCase(Tokens.WETH,       Tokens.ETH,       ChainId.KLAYTN,    ChainId.ETH,         redeem),
        makeTestCase(Tokens.ETH,        Tokens.WETH,      ChainId.ETH,       ChainId.KLAYTN,      depositETHAndSwap),
        makeTestCase(Tokens.WETH,       Tokens.WETH,      ChainId.OPTIMISM,  ChainId.KLAYTN,      swapAndRedeem),
