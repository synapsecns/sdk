...
describe("SynapseBridge - Provider Interactions tests", function(this: Mocha.Suite) {
    ...
    let testCases: TestCase[] = [
        ...
        makeTestCase(Tokens.NUSD,   Tokens.USDT,   ChainId.POLYGON,   ChainId.FANTOM,    testAmts.ironMaiden,  failAllOpts(true)),
    ];

    const dfkTestCases: TestCase[] = [
        makeTestCase(Tokens.AVAX,        Tokens.SYN_AVAX,    ChainId.AVALANCHE,   ChainId.HARMONY,    parseEther("0.6"),   {executeSuccess: false,  canBridge: false,  callStatic: false}),
        makeTestCase(Tokens.AVAX,        Tokens.WAVAX,       ChainId.AVALANCHE,   ChainId.DFK,        parseEther("0.6"),   {executeSuccess: false,  canBridge: false,  callStatic: false}),
        ...
        makeTestCase(Tokens.JEWEL,       Tokens.SYN_JEWEL,   ChainId.AVALANCHE,   ChainId.HARMONY,    parseEther("1.5"),   {executeSuccess: false,  canBridge: false,  callStatic: true}),
        makeTestCase(Tokens.JEWEL,       Tokens.JEWEL,       ChainId.AVALANCHE,   ChainId.HARMONY,    parseEther("1.5"),   {executeSuccess: false,  canBridge: false,  callStatic: true}),
        makeTestCase(Tokens.MULTIJEWEL,  Tokens.JEWEL,       ChainId.AVALANCHE,   ChainId.DFK,        parseEther("0.75"),  {executeSuccess: false,  canBridge: false,  callStatic: true}),
        makeTestCase(Tokens.MULTIJEWEL,  Tokens.JEWEL,       ChainId.AVALANCHE,   ChainId.DFK,        parseEther("3"),     {executeSuccess: false,  canBridge: false,  callStatic: true}),
