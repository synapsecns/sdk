...
describe("SynapseBridge - Bridge/Swap tests", function(this: Mocha.Suite) {
    describe("checkSwapSupported", function(this: Mocha.Suite) {
        ...
        let testCases: TestCase[] = [
            ...
            makeBridgeSwapTestCase(ChainId.FANTOM,    Tokens.MIM,    ChainId.BSC,       Tokens.USDT,   false),
            ...
            makeBridgeSwapTestCase(ChainId.FANTOM,    Tokens.MIM,    ChainId.POLYGON,   Tokens.DAI,    false),
    ...
    describe("getEstimatedBridgeOutput", function(this: Mocha.Suite) {
        ...
        let testCases: TestCase[] = [
            ...
            makeTestCase(Tokens.MIM,     Tokens.NUSD,    ChainId.FANTOM,    ChainId.ETH, undefined, false, true),
            ...
            makeTestCase(Tokens.MIM,     Tokens.DAI,     ChainId.FANTOM,    ChainId.POLYGON,   undefined, false, true),
